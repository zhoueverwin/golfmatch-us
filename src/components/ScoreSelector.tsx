...
import { SCORE_OPTIONS } from "../constants/filterOptions";

interface ScoreSelectorProps {
  visible: boolean;
  selectedScore: number | undefined;
  onClose: () => void;
  onApply: (score: number | undefined) => void;
}
...
const ScoreSelector: React.FC<ScoreSelectorProps> = ({
  ...
  const [tempSelected, setTempSelected] = React.useState<number | undefined>(
    selectedScore
  );

  React.useEffect(() => {
    setTempSelected(selectedScore);
