...
import { LAST_LOGIN_OPTIONS } from "../constants/filterOptions";

interface LastLoginSelectorProps {
  visible: boolean;
  selectedDays: number | null | undefined;
  onClose: () => void;
  onApply: (days: number | null | undefined) => void;
}

const LastLoginSelector: React.FC<LastLoginSelectorProps> = ({
  visible,
  selectedDays,
  onClose,
  onApply,
    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>最終ログイン</Text>
