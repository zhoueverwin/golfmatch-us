 ...
 *
 * Form for creating a new recruitment.
 * Fields:
 * - Title, Description
 * - Date, Time
 * - Course (search via GORA API)
 * - Course Type (IN/OUT/THROUGH)
 * - Slots, Requirements
 * - Cost, Notes
 */
...
import { useCreateRecruitment } from '../hooks/queries/useRecruitments';
...
const RecruitmentCreateScreen: React.FC = () => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const prefecture = selectedCourse?.prefecture || '';
      ...
      await createMutation.mutateAsync({
        ...
        input: {
          ...
          golf_course_id: selectedCourse?.id,
...
export default RecruitmentCreateScreen;
